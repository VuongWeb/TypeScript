        ...
        <tbody>
          {props.products.map((item, i) => {
            ...
            return <tr key={i}>
              ...
              <td className='px-12 py-4'><button className='bg-red-600 text-white p-2 rounded-2xl' onClick={() => { if (window.confirm('Bạn có chắc chắn xóa !')) { props.onRemove(item._id) }; }}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
